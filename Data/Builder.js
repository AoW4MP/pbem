...
function createStatusEffectTooltip(effectData, handlerType = "status") {
    ...
    image.setAttribute("src", "/pbem/Icons/UnitIcons/" + effectData.icon + ".png");
...
function ShowUnitFromLink() {
    ...
    document.title = "Age of Wonders 4 PBEM - " + GetUnitTierAndName(unitID).split(">")[2];
...
function ShowSpellFromLink() {
    ...
    for (const { key, title, action } of paramMap) {
        ...
        if (id) {
            ...
            document.title = `Age of Wonders 4 PBEM - ${titleText}`;
    ...
    for (let i = 0; i < list.length; i++) {
        ...
        switch (cardType) {
            case "unitTomeIcon":
                ...
                btn.innerHTML =
                    '<img style="float:left;" src="/pbem/Icons/TomeIcons/' +
                    splitIcon[1] +
                    ".png\" width='25px'\">" +
...
function addUnitTypeIcon(a, holder, origin) {
    ...
    imag.setAttribute("src", "/pbem/Icons/UnitIcons/" + iconsrc + ".png");
    imag.setAttribute("onerror", "this.setAttribute('src','/pbem/Icons/Text/mp.png')");
    imag.setAttribute("width", "40");
    imag.setAttribute("height", "40");

    spa.innerHTML =
        '<img style="float:left; height:30px; width:30px" src="/pbem/Icons/UnitIcons/' +
        iconsrc +
    ...
    if (origin !== "") {
        ...
        if (roleNames.includes(iconName)) {
            ...
            unitRole.setAttribute("src", `/pbem/Icons/Text/${clearname}.png`);
        }
    }
...
function addAbilityslot(a, holder, list, enchant, uniqueMedal) {
                        ...
                        if ("type2" in jsonEnchantments[k].attack[t]) {
                            if (jsonEnchantments[k].attack[t].type2.indexOf("*") != -1) {
                                if (
                                    ...
                                    abilityEncht +=
                                        '<bullet><img src="/pbem/Icons/SpellIcons/' +
    ...
    let abilityIconType = "";
    imag.setAttribute("src", "/pbem/Icons/UnitIcons/" + abilityIcon + ".png");

    abilityIconType = GetAbilityBackground(abilityDam);

    imag.setAttribute(
        "style",
        'background-image: url("/pbem/Icons/Interface/' +
            abilityIconType +
    ...
    if (Cooldown != "") {
        ...
        imageExtra.setAttribute("src", "/pbem/Icons/Text/turn.png");
    ...
    if (Once != "") {
        imageExtra = document.createElement("IMG");
        imageExtra.setAttribute("src", "/pbem/Icons/Text/once.png");
        imageExtra.setAttribute("style", " position: absolute; height: 18px; left: 0px;bottom: 4px;");
        btn.append(imageExtra);
    }
...
/*function GetAbilityToolTip(ability) {
    ...
    abilityHighlighter.innerHTML =
        "<img style=\"float:left; height:50px; width:50px; background-image:url('/pbem/Icons/Interface/" +
        abilityIconType +
        '.png\');background-repeat: no-repeat;background-size: 50px" src="/pbem/Icons/UnitIcons/' +
        abilityIcon +
        '.png">';
...
function GetAbilityToolTip(ability, uniqueMedal) {
    ...
    abilityIcon.setAttribute("src", "/pbem/Icons/UnitIcons/" + ability.icon + ".png");
    abilityIcon.style.backgroundImage = "url(/pbem/Icons/Interface/" + abilityBackground + ".png";
...
function addUniquePassiveSlot(enchantment, descr, div, overwrite) {
    ...
    imag.setAttribute("src", "/pbem/Icons/SpellIcons/" + abilityIcon + ".png");
    imag.setAttribute("onerror", "this.setAttribute('src','/pbem/Icons/Text/mp.png')");
    imag.setAttribute("width", "40");
    imag.setAttribute("height", "40");
...
function CreatePassiveSlotToolTip(abilityIcon, abilityName, abilityDescr) {
    ...
    spa.innerHTML =
        '<div class="abilityHighLighter"><img style="float:left; position:relative; top:-7px; height:30px; width:30px" src="/pbem/Icons/UnitIcons/' +
        abilityIcon +
    ...
    for (let j = 0; j < jsonUnitAbilities.length; j++) {
        if (a === jsonUnitAbilities[j].slug) {
            ...
            if (a.indexOf("Frost") !== -1) {
                imag.setAttribute("src", "/pbem/Icons/Text/frost_resistance.png");
                spa.innerHTML += "<defensefrost></defensefrost>";
            }
            if (a.indexOf("Blight") !== -1) {
                imag.setAttribute("src", "/pbem/Icons/Text/blight_resistance.png");
                spa.innerHTML += "<defenseblight></defenseblight>";
            }
            if (a.indexOf("Fire") !== -1) {
                imag.setAttribute("src", "/pbem/Icons/Text/fire_resistance.png");
                spa.innerHTML += "<defensefire></defensefire>";
            }
            if (a.indexOf("Spirit") !== -1) {
                imag.setAttribute("src", "/pbem/Icons/Text/spirit_resistance.png");
                spa.innerHTML += "<defensespirit></defensespirit>";
            }

            if (a.indexOf("Shock") !== -1) {
                imag.setAttribute("src", "/pbem/Icons/Text/lightning_resistance.png");
...
function addstatusResistanceSlot(a, holder) {
    ...
    imag.setAttribute("src", "/pbem/Icons/Text/status_resistance.png");
...
function showUnit(unitID, subcultureCheck, resID, divOrigin) {
    ...
    imagelink.setAttribute("src", "/pbem/PreviewsAvif/" + unitEN.id + ".avif");
    if (imagelink.getAttribute("src") === "/pbem/PreviewsAvif/undefined") {
        imagelink.setAttribute("src", "/pbem/PreviewsAvif/abductor.avif");
    }
    // }
    ...
    if (MountedSpecialList.includes(unitID) || CheckIfOptionalCavalry(unitID)) {
        ...
        imag = document.createElement("IMG");
        imag.setAttribute("src", "/pbem/Icons/Text/MountInteraction.png");
    ...
    if (CheckIfFormUnit(unitEN)) {
        ...
        imag.setAttribute("src", "/pbem/Icons/FactionCreation/human.png");

        imag.setAttribute("width", "40");
        imag.setAttribute("height", "40");

        span.innerHTML =
            '<img style="float:left; height:30px; width:30px" src="/pbem/Icons/FactionCreation/human.png"><p style="color: #d7c297" class="abilityHighLighter">' +
...
function backtrackUnitOrigins(unitData, name, holder) {
    ...
    if (culture != "thing") {
        ...
        const imgSrc = `/pbem/Icons/Text/${culture}.png`;
        const imgFallbackSrc = `/pbem/Icons/Text/mp.png`;
        const link = `/pbem/HTML/${capitalized}Units.html`;
    ...
    if (subculture != "") {
        ...
        const imgSrc = `/pbem/Icons/Text/${subculture}.png`;
        const imgFallbackSrc = `/pbem/Icons/Text/mp.png`;
        //  const link = `/pbem/HTML/${capitalized}Units.html`;
    ...
    for (let x = 0; x < tomes.length; x++) {
        ...
        const imgSrc = `/pbem/Icons/TomeIcons/${tomes[x].id}.png`;
        const imgFallbackSrc = `/pbem/Icons/Text/mp.png`;
        const link = `/pbem/HTML/Spells.html?tome=${tomes[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < spells.length; x++) {
        ...
        const imgSrc = `/pbem/Icons/SpellIcons/${spells[x].id}.png`;
        const imgFallbackSrc = `/pbem/Icons/Text/mp.png`;
        const link = `/pbem/HTML/Spells.html?spell=${spells[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < siege.length; x++) {
        ...
        const imgSrc = `/pbem/Icons/SiegeProjectIcons/${siege[x].icon}.png`;
        const imgFallbackSrc = `/pbem/Icons/Text/mp.png`;
        const link = `/pbem/HTML/Spells.html?siege=${siege[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < struc.length; x++) {
        ...
        const imgSrc = `/pbem/Icons/UpgradeIcons/${struc[x].icon}.png`;
        const imgFallbackSrc = `/pbem/Icons/Text/mp.png`;
        const link = `/pbem/HTML/Spells.html?structure=${struc[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < traitFound.length; x++) {
        ...
        const imgSrc = `/pbem/Icons/TraitIcons/${traitFound[x].id}.png`;
        const imgFallbackSrc = `/pbem/Icons/Text/mp.png`;
        const link = `/pbem/HTML/Spells.html?trait=${traitFound[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < wonder.length; x++) {
        ...
        const imgSrc = `/pbem/Icons/StructurePics/${wonder[x].id}.png`;
        const imgFallbackSrc = `/pbem/Icons/Text/mp.png`;
        const link = `/pbem/HTML/Spells.html?wonder=${wonder[x].id}`;
    ...
    for (let x = 0; x < tree.length; x++) {
        ...
        const imgSrc = `/pbem/Icons/EmpireProgressionIcons/${tree[x].id}.png`;
        const imgFallbackSrc = `/pbem/Icons/Text/mp.png`;
        const link = `/pbem/HTML/EmpireTree.html`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < unitAbility.length; x++) {
        ...
        const imgSrc =
            unitAbility[0] != ""
                ? `/pbem/Icons/UnitIcons/${unitAbility[x][1].icon}.png`
                : `/pbem/Icons/HeroSkillIcons/${unitAbility[x][1].icon}.png`;
        const imgFallbackSrc = `/pbem/Icons/Text/mp.png`;
        const link = `/pbem/HTML/Units.html?unit=${unitAbility[x][0].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < heroSkill.length; x++) {
        ...
        const imgSrc =
            heroSkill[x][0] != ""
                ? `/pbem/Icons/UnitIcons/${heroSkill[x][0].icon}.png`
                : `/pbem/Icons/HeroSkillIcons/${heroSkill[x][1].icon}.png`;
        const imgFallbackSrc = `/pbem/Icons/Text/mp.png`;
        const link = `/pbem/HTML/Spells.html?skill=${heroSkill[x][1].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < governance.length; x++) {
        ...
        const imgSrc = `/pbem/Icons/GovernanceIcons/${governance[x].icon}.png`;
        const imgFallbackSrc = `/pbem/Icons/Text/mp.png`;
        const link = `/pbem/HTML/Spells.html?governance=${governance[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    if (evolve != "") {
        ...
        const imgSrc = `/pbem/Icons/UnitIcons/evolve.png`;
        const imgFallbackSrc = `/pbem/Icons/Text/mp.png`;
        const link = `/pbem/HTML/Units.html?unit=${evolve.id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
}
...
function addLevelUpInfo(units, a, holder) {
    ...
    if (evolveTarget) {
        const levelText = `<bullet> Evolves/Promotes into <hyperlink><a href="/pbem/HTML/Units.html?unit=${evolveTarget}" target="_blank">${lookupUnit(evolveTarget)}</a></hyperlink></bullet>`;
...
function showSiegeProject(id, showOrigin, divOrigin) {
    ...
    if (siegeProject != undefined) {
        ...
        imagelink.setAttribute("src", "/pbem/Icons/SiegeProjectIcons/" + siegeProject.icon + ".png");
...
function showEmpireUpgrade(skill, showOrigin, divOrigin) {
    ...
    imagelink.setAttribute("src", "/pbem/Icons/SpellIcons/" + imageLinkName + ".png");
...
function showTome(a, divOrigin) {
    ...
    imagelink.setAttribute("src", "/pbem/Icons/TomeIcons/" + tomeEN.icon + ".png");
...
function createTooltipForEnchant(item) {
    ...
    image.setAttribute("src", "/pbem/Icons/SpellIcons/" + item.icon + ".png");
...
function SetEnchantment(evt) {
    if (!isInArray(evt.currentTarget.activeEnchantList, evt.currentTarget.enchant)) {
        ...
        image.setAttribute("src", "/pbem/Icons/SpellIcons/" + evt.currentTarget.enchant.icon + ".png");
...
function showStructure(a, showOrigin, divOrigin) {
    ...
    imagelink.setAttribute("src", "/pbem/Icons/UpgradeIcons/" + structureLoc.icon + ".png");
...
function addUnlockableUnitsToStructure(a, keyword, unitList, descriptionDiv, unitTypesDiv) {
    if (a.indexOf(keyword) !== -1) {
        ...
        for (let i = 0; i < unitList.length; i++) {
            ...
            div.innerHTML =
                "<bullet>" +
                '<a href="/pbem/HTML/Units.html?unit=' +
                unitList[i] +
                '" target="_blank">' +
...
function showCosmicHappening(a, divOrigin) {
    ...
    for (j in jsonCosmicHappenings) {
        if (a === jsonCosmicHappenings[j].id) {
            ...
            imagelink.setAttribute("src", "/pbem/Icons/CosmicHappenings/category_icon_" + categoryLink + ".png");
            ...
            preview.setAttribute("style", 'background-image: url("/pbem/Icons/CosmicHappenings/' + imagePos);

            preview.setAttribute("src", "/pbem/Icons/Interface/Runecircle.png");
...
function showWorldStructure(a, divOrigin) {
    ...
    if (structure.type.indexOf("wonder") != -1) {
        ...
        imagelink.setAttribute("src", "/pbem/Icons/Text/landmark.png");
        imagelink.setAttribute("id", "modicon" + a);
        imagelink.setAttribute("style", "background-image: none");
    } else {
        imagelink.setAttribute("src", "/pbem/Icons/WorldStructures/" + a + ".png");
        imagelink.setAttribute("id", "modicon" + a);
        imagelink.setAttribute("style", "background-image: none");
    }
    ...
    let preview = divOrigin.querySelector("#structurepreview");
    preview.setAttribute("src", "/pbem/Icons/StructurePics/" + a + ".png");
...
function FindCombatEnchantment(combatID) {
    ...
    let div = document.createElement("DIV");
    div.innerHTML =
        '<img style="float:left; height:80px; padding:10px" src="/pbem/Icons/CombatEnchantments/' +
...
function showDestinyTrait(trait, divOrigin) {
    ...
    if (traitEN != undefined) {
        ...
        imagelink.setAttribute("src", "/pbem/Icons/EmpireProgressionIcons/" + traitEN.id + ".png");
...
function showEmpireTree(a, divOrigin) {
    ...
    for (j in jsonEmpire) {
        if (a === jsonEmpire[j].id) {
            ...
            imagelink.setAttribute("src", "/pbem/Icons/EmpireProgressionIcons/" + a + ".png");
...
function showUnitUnlock(a, divOrigin) {
    ...
    imagelink.setAttribute("src", "/pbem/Icons/SpellIcons/" + a.unit_slug + ".png");
...
function showItem(itemLoc, divOrigin) {
    ...
    tomeOriginIcon.setAttribute("src", "/pbem/Icons/UnitIcons/" + itemLoc.icon + ".png");
}
...
function showTraitSetup(currentTrait, divOrigin, loc) {
    ...
    imagelink.setAttribute("src", "/pbem/Icons/TraitIcons/" + iconLink + ".png");
    imagelink.setAttribute("style", "background-image:none");
    imagelink.setAttribute("onerror", "this.setAttribute('src','/pbem/Icons/Text/empty.png')");
}
...
function showHeroTrait(a, divOrigin) {
    ...
    let imagelink = divOrigin.querySelector("#modicon");
    imagelink.setAttribute("src", "/pbem/Icons/AmbitionIcons/" + thisAmbition.icon + ".png");
    imagelink.setAttribute("style", "background-image:none");
...
function showHeroGov(data, check, divOrigin) {
    ...
    let imagelink = divOrigin.querySelector("#modicon");
    imagelink.setAttribute("src", "/pbem/Icons/GovernanceIcons/" + thisGovernance.icon.toLowerCase() + ".png");
    imagelink.setAttribute("style", "background-image:none");
    found = true;
}
...
function showSkill(a, checkInAbilities, icon_slug, category, level, group_name, divOrigin) {
    ...
    if (a.type === "signature") {
        ...
        imagelink.setAttribute("src", "/pbem/Icons/UnitIcons/" + icon_slug + ".png");
...
function backtraceTomeOriginAndTier(spell, showorigin, modCard) {
    ...
    if (tomespells != undefined) {
        if (showorigin) {
            ...
            tomeOriginIcon.setAttribute("src", "/pbem/Icons/TomeIcons/" + tomespells.icon + ".png");
            const wrap = tomeOriginName.innerHTML;
            tomeOriginName.innerHTML =
                '<a href="/pbem/HTML/Spells.html?tome=' + tomespells.id + '" target="_blank">' + wrap + "</a>";
