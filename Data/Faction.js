...
function SelectSymbol(origin) {
    ...
    symbolElement.setAttribute("src", "/pbem/Icons/Symbols/SigilIcons_" + origin + ".gif");
...
function SetSkillPathInfoSmall(buttonHolder, origin) {
    ...
    image.src = "/pbem/Icons/UnitIcons/" + origin.icon + ".png"; // Set the image source to your image file
...
function SetTomePathInfoSmall(buttonHolder, origin) {
    ...
    image.src = "/pbem/Icons/TomeIcons/" + origin.id + ".png"; // Set the image source to your image file
...
function createImage(type, origin) {
    ...
    switch (type) {
        ...
        case "SubType":
            ...
            break;
        case "Class":
            setImage(`/pbem/Icons/Text/${origin.icon}.png`);
            break;
        case "Signature":
        case "Ascension":
        ...
        case "Symbol":
            ...
            setImage(`/pbem/Icons/Symbols/SigilIcons_${symbolId}.gif`);
            break;
    }
...
function CreateSpellIcon(listEntry, colorEntry) {
    ...
    smallIcon.setAttribute("src", "/pbem/Icons/SpellIcons/" + iconLink + ".png");
...
function CreateUnitIcon(listEntry, colorEntry) {
    ...
    allAbilities.innerHTML +=
        ...
        listEntry.hp +
        '<img src="/pbem/Icons/Text/mp.png" width="25 " height="25 ">' +
        listEntry.mp +
        '<img src="/pbem/Icons/Text/resistance.png" width="25 " height="25 ">' +
        listEntry.resistance +
        '<img  src="/pbem/Icons/Text/armor.png" width="25 " height="25 ">' +
        listEntry.armor +
        "</span><hr>";
    ...
    for (let index = 0; index < list.length; index += 2) {
        for (let i = 0; i < jsonHeroSkills.length; i++) {
            if (jsonHeroSkills[i].id === list[index].slug) {
                ...
                var smallIcon = document.createElement("img");
                smallIcon.setAttribute("src", "/pbem/Icons/UnitIcons/" + jsonHeroSkills[i].icon + ".png");
                smallIcon.setAttribute("width", "20px");
                spell.appendChild(smallIcon);
                spell.appendChild(text);
...
function ShowPassivesOverview(list) {
    ...
    for (let index = 0; index < list.length; index += 2) {
        ...
        text.innerHTML = list[index].name;
        // var smallIcon = document.createElement("img");
        // smallIcon.setAttribute("src", "/pbem/Icons/UnitIcons/" + jsonHeroSkills[index].icon + ".png");
        // smallIcon.setAttribute("width", "20px");
        //    spell.appendChild(smallIcon);
        spell.appendChild(text);
        section.append(spell);
