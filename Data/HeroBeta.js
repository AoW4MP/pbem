...
function SetSkillData(nodeElement, skill) {
    ...
    if (skill == undefined) {
        img.setAttribute("src", "/pbem/Icons/Interface/skill_unassigned.png");
        img.setAttribute("height", "80px");
        return;
    } else {
        img.setAttribute("src", "/pbem/BetaStuff/UnitIcons/" + skill.icon + ".png");
    }
...
function BuildSkillTreeEntry(currentSkill, row, holder, treespace, extraOffset) {
    ...
    if (abilityIconType != "") {
        newNode.style.backgroundImage = "url('/pbem/Icons/Interface/" + abilityIconType + ".png";
    }
